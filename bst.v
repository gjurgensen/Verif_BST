...
Definition _bst__1 : ident := 59%positive.
Definition _insert_bst : ident := 62%positive.
...
Definition _new_bst : ident := 60%positive.
Definition _right : ident := 5%positive.
Definition _search_bst : ident := 61%positive.
...
Definition _t'4 : ident := 67%positive.
Definition _t'5 : ident := 68%positive.
Definition _t'6 : ident := 69%positive.
Definition _t'7 : ident := 70%positive.
Definition _t'8 : ident := 71%positive.
Definition _t'9 : ident := 72%positive.
...
((___builtin_ais_annot,
 ...
 (_insert_bst, Gfun(Internal f_insert_bst)) :: nil).

Definition public_idents : list ident :=
(_insert_bst :: _search_bst :: _new_bst :: _malloc :: ___builtin_debug ::
